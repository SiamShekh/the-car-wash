...
export const InitiatePayment = catchAsync(async (req: Request, res: Response) => {
    ...
    try {
        ...
        const initiate_payment_aamerpay = await axios.post("https://sandbox.aamarpay.com/jsonpost.php", {
            ...
            tran_id: tran_id,
            signature_key: "dbb74894e82415a2f7ff0ec3a97e4183",
            success_url: `https://carwashio-server.vercel.app/api/payment/confirmission?tran=${tran_id}`,
            fail_url: `https://carwashio-server.vercel.app/api/payment/confirmission?tran=${tran_id}`,
